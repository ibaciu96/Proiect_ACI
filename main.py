...
if __name__ == "__main__":
    ...
    parser.add_argument("--file", type=str, default="monalisa.png", help="File to read map from.")
    ...
    parser.add_argument("--shapes", type=int, default=500, help="Number of shapes in a image or number of individuals in a population for method A.")
